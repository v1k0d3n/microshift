...
require (
	...
	github.com/openshift/api v0.0.0-20251117165054-348370f055bf // indirect
...
// OpenShift etcd fork replacements — must match the etcd module's replacements
replace (
...
// Kubernetes module replacements — use local copies from deps/
replace (
